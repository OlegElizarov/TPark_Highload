...
то на один из них с учетом запаса под рост данных в 50% на нем уместится 2048GB/79MB ~ **26 000  пользователей**.
Всего таких серверов понадобится 80 000 000 / 26 000 = **3 076 штук**
Надежность этих данных требуется высокая, поэтому нам придется делать по 2 реплики к каждому.
**Итого 6 152 реплики, 9 224 сервера всего.**
...
перед каждой тысячей серверов БД, но так как важна надежность , то добавим каждому по одному запасному.
